...
def make_tiny_llama(
    ...
    *,
    ...
    scale `noise` — i.e. simulate a fine-tune of the base. Otherwise each
    model gets its own layer-wise sigma profile, norm-gain pattern, and
    spectral structure, so independently seeded models look independent the
    way real unrelated checkpoints do.
    """
